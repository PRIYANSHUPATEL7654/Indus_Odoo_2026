...
public class BuyTransactionHandler implements TransactionHandler {
    ...
    public String handleCreate(TransactionCreateDTO dto) {
        ...
        tx.setTransactionNature(TransactionNature.BUY);
        tx.setTransactionDirection(TransactionDirection.IN);
    ...
    public String handleApproved(String id, TransactionApproveDTO dto) {
        ...
        productInventoryInternalService.addQuantity(tx.getProductId(), totalNetQuantity);
        ...
        for (InventoryTransactionDetails txd : txdList) {
            ...
            if (tx.getAffectsWarehouseQuantity()) {

                batchInventoryService.createBatchInventory(
                        txd.getBatchNo(),
                        txd.getTransactionNo(),
                        tx.getProductId(),
                        txd.getNetQuantity(),
                        txd.getNetQuantity(),
                        0.00,
