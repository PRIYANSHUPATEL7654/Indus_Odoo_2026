...
import {Calendar, CircleCheck, CircleCheckBig, CircleX, FileIcon, Trash2Icon, User} from "lucide-react";
                    ...
                    <div className="w-full h-auto border rounded-lg">
                        <div className="flex p-4 gap-3 items-start justify-between">
                            ...
                            <div className="flex gap-3 items-start">
                                <div className="p-3 border border-dashed rounded-lg flex flex-col justify-between">
