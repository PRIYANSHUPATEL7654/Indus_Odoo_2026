...
import detailsSchema from "@/assets/schema/Inventory/BuyTransaction/Details/schema.json";
import detailsUISchema from "@/assets/schema/Inventory/BuyTransaction/Details/uischema.json";
            ...
            <AlertDialog open={isAlertDialog} onOpenChange={setIsAlertDialog}>
                <AlertDialogContent size="sm">
                    <AlertDialogHeader>
                        ...
                        <AlertDialogTitle>Delete Transaction Details?</AlertDialogTitle>
                        <AlertDialogDescription>
